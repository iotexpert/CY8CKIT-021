...
***************************************/
    ...
    *
    * \globalvars
    *  BLEIOT_UART_rxBufferHead - the start index to put data into the 
    *  software receive buffer.
    *  BLEIOT_UART_rxBufferTail - the start index to get data from the 
    *  software receive buffer.
    *
    *******************************************************************************/
    ...
    *
    * \globalvars
    *  BLEIOT_UART_txBufferHead - the start index to put data into the 
    *  software transmit buffer.
    *  BLEIOT_UART_txBufferTail - start index to get data from the software
    *  transmit buffer.
    *
    *******************************************************************************/
