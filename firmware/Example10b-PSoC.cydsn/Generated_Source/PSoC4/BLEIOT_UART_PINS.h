...
/* Unconfigured pins */
#define BLEIOT_UART_REMOVE_RX_WAKE_SCL_MOSI_PIN  (1u)
#define BLEIOT_UART_REMOVE_RX_SCL_MOSI_PIN      (1u)
#define BLEIOT_UART_REMOVE_TX_SDA_MISO_PIN      (1u)
...
/* Unconfigured pins */
#define BLEIOT_UART_RX_WAKE_SCL_MOSI_PIN (0u == BLEIOT_UART_REMOVE_RX_WAKE_SCL_MOSI_PIN)
#define BLEIOT_UART_RX_SCL_MOSI_PIN     (0u == BLEIOT_UART_REMOVE_RX_SCL_MOSI_PIN)
#define BLEIOT_UART_TX_SDA_MISO_PIN     (0u == BLEIOT_UART_REMOVE_TX_SDA_MISO_PIN)
...
****************************************/
    ...
    #include "BLEIOT_UART_uart_rx_wake_i2c_scl_spi_mosi.h"
#endif /* (BLEIOT_UART_RX_SCL_MOSI) */

#if (BLEIOT_UART_RX_SCL_MOSI_PIN)
    #include "BLEIOT_UART_uart_rx_i2c_scl_spi_mosi.h"
#endif /* (BLEIOT_UART_RX_SCL_MOSI) */

#if (BLEIOT_UART_TX_SDA_MISO_PIN)
    #include "BLEIOT_UART_uart_tx_i2c_sda_spi_miso.h"
#endif /* (BLEIOT_UART_TX_SDA_MISO) */
...
***************************************/
...
#if (BLEIOT_UART_RX_WAKE_SCL_MOSI_PIN)
    #define BLEIOT_UART_RX_WAKE_SCL_MOSI_HSIOM_REG \
                            (*(reg32 *) BLEIOT_UART_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM)
    #define BLEIOT_UART_RX_WAKE_SCL_MOSI_HSIOM_PTR \
                            ( (reg32 *) BLEIOT_UART_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM)
    #define BLEIOT_UART_RX_WAKE_SCL_MOSI_HSIOM_MASK \
                            (BLEIOT_UART_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_MASK)
    #define BLEIOT_UART_RX_WAKE_SCL_MOSI_HSIOM_POS \
                            (BLEIOT_UART_uart_rx_wake_i2c_scl_spi_mosi__0__HSIOM_SHIFT)

    #define BLEIOT_UART_RX_WAKE_SCL_MOSI_INTCFG_REG \
                            (*(reg32 *) BLEIOT_UART_uart_rx_wake_i2c_scl_spi_mosi__0__INTCFG)
    #define BLEIOT_UART_RX_WAKE_SCL_MOSI_INTCFG_PTR \
                            ( (reg32 *) BLEIOT_UART_uart_rx_wake_i2c_scl_spi_mosi__0__INTCFG)
    #define BLEIOT_UART_RX_WAKE_SCL_MOSI_INTCFG_TYPE_POS  (BLEIOT_UART_uart_rx_wake_i2c_scl_spi_mosi__SHIFT)
    #define BLEIOT_UART_RX_WAKE_SCL_MOSI_INTCFG_TYPE_MASK \
                            ((uint32) BLEIOT_UART_INTCFG_TYPE_MASK << \
                                      BLEIOT_UART_RX_WAKE_SCL_MOSI_INTCFG_TYPE_POS)
#endif /* (BLEIOT_UART_RX_WAKE_SCL_MOSI_PIN) */

#if (BLEIOT_UART_RX_SCL_MOSI_PIN)
    #define BLEIOT_UART_RX_SCL_MOSI_HSIOM_REG   (*(reg32 *) BLEIOT_UART_uart_rx_i2c_scl_spi_mosi__0__HSIOM)
    #define BLEIOT_UART_RX_SCL_MOSI_HSIOM_PTR   ( (reg32 *) BLEIOT_UART_uart_rx_i2c_scl_spi_mosi__0__HSIOM)
    #define BLEIOT_UART_RX_SCL_MOSI_HSIOM_MASK  (BLEIOT_UART_uart_rx_i2c_scl_spi_mosi__0__HSIOM_MASK)
    #define BLEIOT_UART_RX_SCL_MOSI_HSIOM_POS   (BLEIOT_UART_uart_rx_i2c_scl_spi_mosi__0__HSIOM_SHIFT)
#endif /* (BLEIOT_UART_RX_SCL_MOSI_PIN) */

#if (BLEIOT_UART_TX_SDA_MISO_PIN)
    #define BLEIOT_UART_TX_SDA_MISO_HSIOM_REG   (*(reg32 *) BLEIOT_UART_uart_tx_i2c_sda_spi_miso__0__HSIOM)
    #define BLEIOT_UART_TX_SDA_MISO_HSIOM_PTR   ( (reg32 *) BLEIOT_UART_uart_tx_i2c_sda_spi_miso__0__HSIOM)
    #define BLEIOT_UART_TX_SDA_MISO_HSIOM_MASK  (BLEIOT_UART_uart_tx_i2c_sda_spi_miso__0__HSIOM_MASK)
    #define BLEIOT_UART_TX_SDA_MISO_HSIOM_POS   (BLEIOT_UART_uart_tx_i2c_sda_spi_miso__0__HSIOM_SHIFT)
    ...
    #define BLEIOT_UART_TX_HSIOM_PTR   ( (reg32 *) BLEIOT_UART_tx_0__HSIOM)
...
#define BLEIOT_UART_RX_WAKE_SCL_MOSI_PIN_INDEX   (0u)
#define BLEIOT_UART_RX_SCL_MOSI_PIN_INDEX       (0u)
#define BLEIOT_UART_TX_SDA_MISO_PIN_INDEX       (1u)
...
#define BLEIOT_UART_RX_WAKE_SCL_MOSI_PIN_MASK ((uint32) 0x01u << BLEIOT_UART_RX_WAKE_SCL_MOSI_PIN_INDEX)
#define BLEIOT_UART_RX_SCL_MOSI_PIN_MASK     ((uint32) 0x01u << BLEIOT_UART_RX_SCL_MOSI_PIN_INDEX)
#define BLEIOT_UART_TX_SDA_MISO_PIN_MASK     ((uint32) 0x01u << BLEIOT_UART_TX_SDA_MISO_PIN_INDEX)
...
#if (BLEIOT_UART_TX_SDA_MISO_PIN)
    #define BLEIOT_UART_CHECK_TX_SDA_MISO_PIN_USED \
                (BLEIOT_UART_PIN_DM_ALG_HIZ != \
                    BLEIOT_UART_GET_P4_PIN_DM(BLEIOT_UART_uart_tx_i2c_sda_spi_miso_PC, \
                                                   BLEIOT_UART_uart_tx_i2c_sda_spi_miso_SHIFT))
#endif /* (BLEIOT_UART_TX_SDA_MISO_PIN) */
...
/* Unconfigured SCB: scl signal */
#elif (BLEIOT_UART_RX_WAKE_SCL_MOSI_PIN)
    #define BLEIOT_UART_SET_I2C_SCL_DR(val) \
                            BLEIOT_UART_uart_rx_wake_i2c_scl_spi_mosi_Write(val)
    ...
    #define BLEIOT_UART_WAIT_SCL_SET_HIGH  (0u == BLEIOT_UART_uart_rx_wake_i2c_scl_spi_mosi_Read())

#elif (BLEIOT_UART_RX_SCL_MOSI_PIN)
    #define BLEIOT_UART_SET_I2C_SCL_DR(val) \
                            BLEIOT_UART_uart_rx_i2c_scl_spi_mosi_Write(val)
    ...
    #define BLEIOT_UART_WAIT_SCL_SET_HIGH  (0u == BLEIOT_UART_uart_rx_i2c_scl_spi_mosi_Read())
...
#elif (BLEIOT_UART_TX_SDA_MISO_PIN)
    #define BLEIOT_UART_WAIT_SDA_SET_HIGH  (0u == BLEIOT_UART_uart_tx_i2c_sda_spi_miso_Read())
#else
...
/* Unconfigured pins */
#define BLEIOT_UART_REMOVE_MOSI_SCL_RX_WAKE_PIN    BLEIOT_UART_REMOVE_RX_WAKE_SCL_MOSI_PIN
#define BLEIOT_UART_REMOVE_MOSI_SCL_RX_PIN         BLEIOT_UART_REMOVE_RX_SCL_MOSI_PIN
#define BLEIOT_UART_REMOVE_MISO_SDA_TX_PIN         BLEIOT_UART_REMOVE_TX_SDA_MISO_PIN
...
/* Unconfigured pins */
#define BLEIOT_UART_MOSI_SCL_RX_WAKE_PIN   BLEIOT_UART_RX_WAKE_SCL_MOSI_PIN
#define BLEIOT_UART_MOSI_SCL_RX_PIN        BLEIOT_UART_RX_SCL_MOSI_PIN
#define BLEIOT_UART_MISO_SDA_TX_PIN        BLEIOT_UART_TX_SDA_MISO_PIN
...
#define BLEIOT_UART_SS0_PIN                BLEIOT_UART_RTS_SS0_PIN
    ...
    #define BLEIOT_UART_MOSI_SCL_RX_WAKE_HSIOM_REG     BLEIOT_UART_RX_WAKE_SCL_MOSI_HSIOM_REG
    #define BLEIOT_UART_MOSI_SCL_RX_WAKE_HSIOM_PTR     BLEIOT_UART_RX_WAKE_SCL_MOSI_HSIOM_REG
    #define BLEIOT_UART_MOSI_SCL_RX_WAKE_HSIOM_MASK    BLEIOT_UART_RX_WAKE_SCL_MOSI_HSIOM_REG
    #define BLEIOT_UART_MOSI_SCL_RX_WAKE_HSIOM_POS     BLEIOT_UART_RX_WAKE_SCL_MOSI_HSIOM_REG

    #define BLEIOT_UART_MOSI_SCL_RX_WAKE_INTCFG_REG    BLEIOT_UART_RX_WAKE_SCL_MOSI_HSIOM_REG
    #define BLEIOT_UART_MOSI_SCL_RX_WAKE_INTCFG_PTR    BLEIOT_UART_RX_WAKE_SCL_MOSI_HSIOM_REG

    #define BLEIOT_UART_MOSI_SCL_RX_WAKE_INTCFG_TYPE_POS   BLEIOT_UART_RX_WAKE_SCL_MOSI_HSIOM_REG
    #define BLEIOT_UART_MOSI_SCL_RX_WAKE_INTCFG_TYPE_MASK  BLEIOT_UART_RX_WAKE_SCL_MOSI_HSIOM_REG
#endif /* (BLEIOT_UART_RX_WAKE_SCL_MOSI_PIN) */

#if (BLEIOT_UART_MOSI_SCL_RX_PIN)
    #define BLEIOT_UART_MOSI_SCL_RX_HSIOM_REG      BLEIOT_UART_RX_SCL_MOSI_HSIOM_REG
    #define BLEIOT_UART_MOSI_SCL_RX_HSIOM_PTR      BLEIOT_UART_RX_SCL_MOSI_HSIOM_PTR
    #define BLEIOT_UART_MOSI_SCL_RX_HSIOM_MASK     BLEIOT_UART_RX_SCL_MOSI_HSIOM_MASK
    #define BLEIOT_UART_MOSI_SCL_RX_HSIOM_POS      BLEIOT_UART_RX_SCL_MOSI_HSIOM_POS
#endif /* (BLEIOT_UART_MOSI_SCL_RX_PIN) */

#if (BLEIOT_UART_MISO_SDA_TX_PIN)
    #define BLEIOT_UART_MISO_SDA_TX_HSIOM_REG      BLEIOT_UART_TX_SDA_MISO_HSIOM_REG
    #define BLEIOT_UART_MISO_SDA_TX_HSIOM_PTR      BLEIOT_UART_TX_SDA_MISO_HSIOM_REG
    #define BLEIOT_UART_MISO_SDA_TX_HSIOM_MASK     BLEIOT_UART_TX_SDA_MISO_HSIOM_REG
    #define BLEIOT_UART_MISO_SDA_TX_HSIOM_POS      BLEIOT_UART_TX_SDA_MISO_HSIOM_REG
...
#define BLEIOT_UART_MOSI_SCL_RX_WAKE_PIN_INDEX BLEIOT_UART_RX_WAKE_SCL_MOSI_PIN_INDEX
#define BLEIOT_UART_MOSI_SCL_RX_PIN_INDEX      BLEIOT_UART_RX_SCL_MOSI_PIN_INDEX
#define BLEIOT_UART_MISO_SDA_TX_PIN_INDEX      BLEIOT_UART_TX_SDA_MISO_PIN_INDEX
...
#define BLEIOT_UART_MOSI_SCL_RX_WAKE_PIN_MASK BLEIOT_UART_RX_WAKE_SCL_MOSI_PIN_MASK
#define BLEIOT_UART_MOSI_SCL_RX_PIN_MASK      BLEIOT_UART_RX_SCL_MOSI_PIN_MASK
#define BLEIOT_UART_MISO_SDA_TX_PIN_MASK      BLEIOT_UART_TX_SDA_MISO_PIN_MASK
