...
static void EZI2C_ScbModeStop(void)
{
    ...
    *******************************************************************************/
    void EZI2C_SetPins(uint32 mode, uint32 subMode, uint32 uartEnableMask)
    {
        ...
        {
            hsiomSel[EZI2C_RX_SDA_MOSI_PIN_INDEX] = EZI2C_HSIOM_I2C_SEL;
            hsiomSel[EZI2C_TX_SCL_MISO_PIN_INDEX] = EZI2C_HSIOM_I2C_SEL;
        ...
        {
            hsiomSel[EZI2C_RX_SDA_MOSI_PIN_INDEX] = EZI2C_HSIOM_SPI_SEL;
            hsiomSel[EZI2C_TX_SCL_MISO_PIN_INDEX] = EZI2C_HSIOM_SPI_SEL;
            hsiomSel[EZI2C_CTS_SCLK_PIN_INDEX] = EZI2C_HSIOM_SPI_SEL;
            ...
            if (EZI2C_SPI_SLAVE == subMode)
            {
                ...
                hsiomSel[EZI2C_RTS_SS0_PIN_INDEX] = EZI2C_HSIOM_SPI_SEL;
        ...
        else /* UART */
        {
            ...
            {
                /* SmartCard */
                hsiomSel[EZI2C_TX_SCL_MISO_PIN_INDEX] = EZI2C_HSIOM_UART_SEL;
                pinsDm  [EZI2C_TX_SCL_MISO_PIN_INDEX] = EZI2C_PIN_DM_OD_LO;
            }
            else /* Standard or IrDA */
            {
                ...
                {
                    hsiomSel[EZI2C_RX_SDA_MOSI_PIN_INDEX] = EZI2C_HSIOM_UART_SEL;
                    pinsDm  [EZI2C_RX_SDA_MOSI_PIN_INDEX] = EZI2C_PIN_DM_DIG_HIZ;
                }
                ...
                if (EZI2C_UART_MODE_STD == subMode)
                {
                    if (0u != (EZI2C_UART_CTS_PIN_ENABLE & uartEnableMask))
                    {
                        ...
                        hsiomSel[EZI2C_CTS_SCLK_PIN_INDEX] = EZI2C_HSIOM_UART_SEL;
                        pinsDm  [EZI2C_CTS_SCLK_PIN_INDEX] = EZI2C_PIN_DM_DIG_HIZ;
                    }
                    ...
                    if (0u != (EZI2C_UART_RTS_PIN_ENABLE & uartEnableMask))
                    {
                        ...
                        hsiomSel[EZI2C_RTS_SS0_PIN_INDEX] = EZI2C_HSIOM_UART_SEL;
                        pinsDm  [EZI2C_RTS_SS0_PIN_INDEX] = EZI2C_PIN_DM_STRONG;
