...
#if (EZI2C_RX_WAKE_SDA_MOSI_PIN)
    #define EZI2C_RX_WAKE_SDA_MOSI_HSIOM_REG \
                            (*(reg32 *) EZI2C_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM)
    #define EZI2C_RX_WAKE_SDA_MOSI_HSIOM_PTR \
                            ( (reg32 *) EZI2C_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM)
    #define EZI2C_RX_WAKE_SDA_MOSI_HSIOM_MASK \
                            (EZI2C_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_MASK)
    #define EZI2C_RX_WAKE_SDA_MOSI_HSIOM_POS \
                            (EZI2C_uart_rx_wake_i2c_sda_spi_mosi__0__HSIOM_SHIFT)

    #define EZI2C_RX_WAKE_SDA_MOSI_INTCFG_REG \
                            (*(reg32 *) EZI2C_uart_rx_wake_i2c_sda_spi_mosi__0__INTCFG)
    #define EZI2C_RX_WAKE_SDA_MOSI_INTCFG_PTR \
                            ( (reg32 *) EZI2C_uart_rx_wake_i2c_sda_spi_mosi__0__INTCFG)
    #define EZI2C_RX_WAKE_SDA_MOSI_INTCFG_TYPE_POS  (EZI2C_uart_rx_wake_i2c_sda_spi_mosi__SHIFT)
    #define EZI2C_RX_WAKE_SDA_MOSI_INTCFG_TYPE_MASK \
